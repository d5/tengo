...
func init() {
	gob.RegisterName("*parser.SourceFileSet", &parser.SourceFileSet{})
	gob.RegisterName("*parser.SourceFile", &parser.SourceFile{})
	gob.RegisterName("*tengo.Array", &Array{})
	gob.RegisterName("*tengo.Bool", &Bool{})
	gob.RegisterName("*tengo.Bytes", &Bytes{})
	gob.RegisterName("*tengo.Char", &Char{})
	gob.RegisterName("*tengo.CompiledFunction", &CompiledFunction{})
	gob.RegisterName("*tengo.Error", &Error{})
	gob.RegisterName("*tengo.Float", &Float{})
	gob.RegisterName("*tengo.ImmutableArray", &ImmutableArray{})
	gob.RegisterName("*tengo.ImmutableMap", &ImmutableMap{})
	gob.RegisterName("*tengo.Int", &Int{})
	gob.RegisterName("*tengo.Map", &Map{})
	gob.RegisterName("*tengo.String", &String{})
	gob.RegisterName("*tengo.Time", &Time{})
	gob.RegisterName("*tengo.Undefined", &Undefined{})
	gob.RegisterName("*tengo.UserFunction", &UserFunction{})
}
