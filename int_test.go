...
func TestInt_BinaryOp(t *testing.T) {
	...
	// int & int
	testBinaryOp(t, &tengo.Int{Value: 0}, token.And, &tengo.Int{Value: 0}, &tengo.Int{Value: 0})
	testBinaryOp(t, &tengo.Int{Value: 1}, token.And, &tengo.Int{Value: 0}, &tengo.Int{Value: 0})
	testBinaryOp(t, &tengo.Int{Value: 0}, token.And, &tengo.Int{Value: 1}, &tengo.Int{Value: 0})
	testBinaryOp(t, &tengo.Int{Value: 1}, token.And, &tengo.Int{Value: 1}, &tengo.Int{Value: 1})
	...
	testBinaryOp(t, &tengo.Int{Value: int64(0xffffffff)}, token.And, &tengo.Int{Value: int64(0xffffffff)}, &tengo.Int{Value: 0xffffffff})
	...
	// int | int
	testBinaryOp(t, &tengo.Int{Value: 0}, token.Or, &tengo.Int{Value: 0}, &tengo.Int{Value: 0})
	testBinaryOp(t, &tengo.Int{Value: 1}, token.Or, &tengo.Int{Value: 0}, &tengo.Int{Value: 1})
	testBinaryOp(t, &tengo.Int{Value: 0}, token.Or, &tengo.Int{Value: 1}, &tengo.Int{Value: 1})
	testBinaryOp(t, &tengo.Int{Value: 1}, token.Or, &tengo.Int{Value: 1}, &tengo.Int{Value: 1})
	...
	testBinaryOp(t, &tengo.Int{Value: int64(0xffffffff)}, token.Or, &tengo.Int{Value: int64(0xffffffff)}, &tengo.Int{Value: 0xffffffff})
	...
	// int ^ int
	testBinaryOp(t, &tengo.Int{Value: 0}, token.Xor, &tengo.Int{Value: 0}, &tengo.Int{Value: 0})
	testBinaryOp(t, &tengo.Int{Value: 1}, token.Xor, &tengo.Int{Value: 0}, &tengo.Int{Value: 1})
	testBinaryOp(t, &tengo.Int{Value: 0}, token.Xor, &tengo.Int{Value: 1}, &tengo.Int{Value: 1})
	testBinaryOp(t, &tengo.Int{Value: 1}, token.Xor, &tengo.Int{Value: 1}, &tengo.Int{Value: 0})
	...
	testBinaryOp(t, &tengo.Int{Value: int64(0xffffffff)}, token.Xor, &tengo.Int{Value: int64(0xffffffff)}, &tengo.Int{Value: 0})
	...
	// int &^ int
	testBinaryOp(t, &tengo.Int{Value: 0}, token.AndNot, &tengo.Int{Value: 0}, &tengo.Int{Value: 1})
	testBinaryOp(t, &tengo.Int{Value: 1}, token.AndNot, &tengo.Int{Value: 0}, &tengo.Int{Value: 0})
	testBinaryOp(t, &tengo.Int{Value: 0}, token.AndNot, &tengo.Int{Value: 1}, &tengo.Int{Value: 0})
	testBinaryOp(t, &tengo.Int{Value: 1}, token.AndNot, &tengo.Int{Value: 1}, &tengo.Int{Value: 1})
	...
	testBinaryOp(t, &tengo.Int{Value: int64(0xffffffff)}, token.AndNot, &tengo.Int{Value: int64(0xffffffff)}, &tengo.Int{Value: 0xffffffff})
