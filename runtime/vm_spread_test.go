...
func TestSpreadableTypes(t *testing.T) {
	expectError(t, `a := 1; [a...]`, nil, "Runtime Error: cannot spread object of type int")
	expectError(t, `a := 1.5; [a...]`, nil, "Runtime Error: cannot spread object of type float")
	expectError(t, `a := "abc"; [a...]`, nil, "Runtime Error: cannot spread object of type string")
	expectError(t, `a := bytes("abc"); [a...]`, nil, "Runtime Error: cannot spread object of type bytes")
	expectError(t, `a := {}; [a...]`, nil, "Runtime Error: cannot spread object of type map")
	expectError(t, `a := immutable({}); [a...]`, nil, "Runtime Error: cannot spread object of type immutable-map")
	expectError(t, `a := func(){return []}; [a...]`, nil, "Runtime Error: cannot spread object of type compiled-function")
	expectError(t, `a := (func() { inner := 0; return func(){return [inner]}; })(); [a...]`, nil, "Runtime Error: cannot spread object of type closure")
}
