...
func timesSleep(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
...
func timesParseDuration(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesSince(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesUntil(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesDurationHours(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesDurationMinutes(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesDurationNanoseconds(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesDurationSeconds(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesDurationString(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesMonthString(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesDate(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 7 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesNow(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 0 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesParse(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesUnix(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesAdd(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesSub(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesAddDate(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 4 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesAfter(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesBefore(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeYear(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeMonth(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeDay(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeWeekday(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeHour(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeMinute(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeSecond(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeNanosecond(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeUnix(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeUnixNano(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeFormat(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesIsZero(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesToLocal(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesToUTC(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeLocation(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func timesTimeString(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
