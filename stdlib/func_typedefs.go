...
func FuncAR(fn func()) objects.CallableFunc {
	return func(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
		if len(args) != 0 {
...
func FuncASRS(fn func(string) string) objects.CallableFunc {
	return func(_ objects.RuntimeHooks, args ...objects.Object) (objects.Object, error) {
		if len(args) != 1 {
			return nil, objects.ErrWrongNumArguments
		}
