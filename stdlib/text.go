...
func textREMatch(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
...
func textREFind(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	numArgs := len(args)
...
func textREReplace(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 3 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func textRESplit(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	numArgs := len(args)
	if numArgs != 2 && numArgs != 3 {
		err = objects.ErrWrongNumArguments
		return
...
func textRECompile(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func textReplace(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 4 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func textSubstring(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	argslen := len(args)
...
func textPadLeft(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	argslen := len(args)
	if argslen != 2 && argslen != 3 {
		err = objects.ErrWrongNumArguments
		return
...
func textPadRight(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	argslen := len(args)
	if argslen != 2 && argslen != 3 {
		err = objects.ErrWrongNumArguments
		return
...
func textRepeat(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
...
func textJoin(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
		return nil, objects.ErrWrongNumArguments
	}
...
func textFormatBool(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func textFormatFloat(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 4 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func textFormatInt(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func textParseBool(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func textParseFloat(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 2 {
		err = objects.ErrWrongNumArguments
		return
	}
...
func textParseInt(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 3 {
		err = objects.ErrWrongNumArguments
		return
	}
