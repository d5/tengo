...
func osReadFile(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
...
func osStat(_ objects.RuntimeHooks, args ...objects.Object) (ret objects.Object, err error) {
	if len(args) != 1 {
		return nil, objects.ErrWrongNumArguments
	}
...
func osCreate(_ objects.RuntimeHooks, args ...objects.Object) (objects.Object, error) {
	if len(args) != 1 {
		return nil, objects.ErrWrongNumArguments
	}
...
func osOpen(_ objects.RuntimeHooks, args ...objects.Object) (objects.Object, error) {
	if len(args) != 1 {
		return nil, objects.ErrWrongNumArguments
	}
...
func osOpenFile(_ objects.RuntimeHooks, args ...objects.Object) (objects.Object, error) {
	if len(args) != 3 {
		return nil, objects.ErrWrongNumArguments
	}
...
func osArgs(_ objects.RuntimeHooks, args ...objects.Object) (objects.Object, error) {
	if len(args) != 0 {
		return nil, objects.ErrWrongNumArguments
	}
...
func osFuncASFmRE(name string, fn func(string, os.FileMode) error) *objects.UserFunction {
	return &objects.UserFunction{
		Name: name,
		Value: func(_ objects.RuntimeHooks, args ...objects.Object) (objects.Object, error) {
			if len(args) != 2 {
				return nil, objects.ErrWrongNumArguments
			}
...
func osLookupEnv(_ objects.RuntimeHooks, args ...objects.Object) (objects.Object, error) {
	if len(args) != 1 {
		return nil, objects.ErrWrongNumArguments
	}
...
func osExpandEnv(_ objects.RuntimeHooks, args ...objects.Object) (objects.Object, error) {
	if len(args) != 1 {
		return nil, objects.ErrWrongNumArguments
	}
...
func osExec(_ objects.RuntimeHooks, args ...objects.Object) (objects.Object, error) {
	if len(args) == 0 {
		return nil, objects.ErrWrongNumArguments
	}
...
func osFindProcess(_ objects.RuntimeHooks, args ...objects.Object) (objects.Object, error) {
	if len(args) != 1 {
		return nil, objects.ErrWrongNumArguments
	}
...
func osStartProcess(_ objects.RuntimeHooks, args ...objects.Object) (objects.Object, error) {
	if len(args) != 4 {
		return nil, objects.ErrWrongNumArguments
	}
